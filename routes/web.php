...
Route::get('report-trackings/print', [ReportTrackingController::class, 'printView'])->name('report-trackings.print');
...
Route::get('annual-reports/print', [AnnualReportController::class, 'printView'])->name('annual-reports.print');
