...
export default function FilterWithoutInput({ params, setParams, state, children }) {
    ...
    return (
        <div className="flex w-full flex-col gap-4 px-4 py-2 lg:flex-row lg:items-center">
            <Select value={String(params?.load)} onValueChange={(e) => setParams({ ...params, page: 1, load: e })}>
