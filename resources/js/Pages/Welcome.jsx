...
export default function Welcome({ auth }) {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="min-h-screen bg-gradient-to-b from-white to-emerald-300 dark:from-zinc-900 dark:to-zinc-800 text-gray-800 transition-colors duration-300 dark:text-gray-200">
                {/* --- Header / Navbar --- */}
